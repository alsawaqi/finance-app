    ...
    public function uploadCommercialRegistration(Request $request, FinanceRequest $financeRequest): JsonResponse
    {
        ...
        DB::transaction(function () use ($financeRequest, $contract, $file, $client) {
            ...
            RequestTimelineLogger::log(
                ...
                $client->id,
                'Client uploaded Chamber of Commerce authenticated contract',
                'قام العميل برفع العقد الموثق من الغرفة التجارية',
                'The client uploaded the Chamber of Commerce authenticated contract for admin review.',
                'قام العميل برفع العقد الموثق من الغرفة التجارية لمراجعته من الإدارة.',
                [
                    'contract_id' => $contract->id,
                ],
            );
