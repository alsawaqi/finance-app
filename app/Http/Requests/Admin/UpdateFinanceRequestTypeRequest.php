...
class UpdateFinanceRequestTypeRequest extends FormRequest
{
    ...
    {
        $financeRequestTypeId = $this->route('financeRequestType')?->id;

        return [
            'slug' => ['nullable', 'string', 'max:255', Rule::unique('finance_request_types', 'slug')->ignore($financeRequestTypeId)],
